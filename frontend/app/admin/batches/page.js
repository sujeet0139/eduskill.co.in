...
export default function AdminBatches() {
  ...
  const openEdit = (b) => {
    setForm({ ...EMPTY, ...b, course_id: b.course_id || "", program_id: b.program_id || "", mentor_id: b.mentor_id || "",
    ...
    <>
      ...
      <TableWrap>
        <thead className="bg-gray-50">
          <tr><Th>Name</Th><Th>Course / Program</Th><Th>Mentor</Th><Th>Dates</Th><Th>Seats</Th><Th>Status</Th><Th>Actions</Th></tr>
        </thead>
